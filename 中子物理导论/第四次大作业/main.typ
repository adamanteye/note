...
grid(row-gutter: 1em, rows: 2, figure(image("img/6.png", height: 40%), caption: [LiGl探测器阵列]),figure(image("img/7.png", height: 40%), caption: [平行板雪崩计数器])))
== 实验设置
...
= 实验结论
== 预裂变不平衡与入射中子能量的关系
#grid(column-gutter: 1em, columns: 2, figure(image("img/2.png",height: 60%),caption: [$isotope("Pu", a:239)(n,f)$中子的能量依赖性]),[
#pause
...
== 预裂变不平衡与测量角度的关系
#grid(column-gutter: 1em, columns: 2, figure(image("img/3.png",height: 60%),caption: [$isotope("Pu", a:239)(n,f)$中子的角分布依赖性]),[
#pause

...
#grid(
  ...
  [
    ...
    #pause
    实验中,测得的瞬发中子谱(*prompt fission neutron spectrum, PFNS*)包括了后裂变中子谱与预平衡中子谱.前者对应前三裂变机会,后者对应第四裂变机会.
  ...
  figure(image("img/1.png", height: 75%), caption: [入射中子能量与反应道的关系]),
)

#pause
这篇论文@kelly_preequilibrium_2019 验证上述两个特征,并首次给出了角分布的实验结果,于2019年发表在PRL
== 预裂变中子谱与能量和角度的关系
...
#grid(
  columns: 2,
  column-gutter: 2em,
  figure(image("img/2.png", height: 55%)), figure(image("img/3.png", height: 55%)),
)
= 实验测量和分析
== 实验装置
#grid(
...
#grid(
  column-gutter: 1em,
  columns: 2,
  figure(image("img/2.png", height: 60%), caption: [$isotope("Pu", a: 239)(n,f)$中子的能量依赖性]),
  [
    #pause
...
#grid(
  column-gutter: 1em,
  columns: 2,
  figure(image("img/3.png", height: 60%), caption: [$isotope("Pu", a: 239)(n,f)$中子的角分布依赖性]),
  [
    #pause
...
#grid(
  ...
  columns: 2,
  figure(
    image("img/4.png", height: 60%),
    caption: [$isotope("Pu", a: 239)(n,f)$出射方向30$unit("d")\/$150$unit("d")$计数],
  ),
  [
...
#grid(
  column-gutter: 1em,
  columns: (1.5fr, 1fr),
  figure(image("img/5.png", width: 100%), caption: [$isotope("Pu", a: 239)(n,f)$的角分布实验数据与拟合分析]),
  [
...
== 相关研究
- 2024年,洛斯阿拉莫斯国家实验室和劳伦斯利弗莫尔国家实验室合作,对$isotope("Pu", a: 240)(s f)$和$isotope("Pu", a: 240)(n,f)$测量了更精确的瞬发裂变谱@kelly_measurement_2024
- 2023年,$isotope("Pu", a: 240)(n,f)$预裂变中子的各向异性@Maslov:2023scu
- 2020年,1-20MeV中子诱导$isotope("Pu", a: 239)(n,f)$的10K-10MeV瞬发裂变谱@Kelly:2020bqf
#show: appendix
